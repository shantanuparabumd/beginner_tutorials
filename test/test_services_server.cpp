...
public:
  ...
  {
    impl_ = node.create_service<beginner_tutorials::srv::ModifyString>(
        ...
        const std::shared_ptr<beginner_tutorials::srv::ModifyString::Request> request)
      {
        ...
        handle_defered_response_thread_ = std::thread(
          ...
          {
            beginner_tutorials::srv::ModifyString::Response response;
            response.c = request->a + request->b;
...
private:
  std::shared_ptr<rclcpp::Service<beginner_tutorials::srv::ModifyString>> impl_;
...
int main(int argc, char ** argv)
{
  ...
  auto service_noreqid = node->create_service<beginner_tutorials::srv::ModifyString>(
    "add_two_ints_noreqid", handle_add_two_ints_noreqid);

  auto service_reqid = node->create_service<beginner_tutorials::srv::ModifyString>(
    "add_two_ints_reqid", handle_add_two_ints_reqid);

  auto service_return_req = node->create_service<beginner_tutorials::srv::ModifyString>(
  ...
  auto derefed_cb_with_handle = node->create_service<beginner_tutorials::srv::ModifyString>(
    "add_two_ints_defered_cb_with_handle",
    [node, &timer](
      const std::shared_ptr<rclcpp::Service<beginner_tutorials::srv::ModifyString>> handle,
      const std::shared_ptr<rmw_request_id_t> request_header,
      const std::shared_ptr<beginner_tutorials::srv::ModifyString::Request> request)
    {
